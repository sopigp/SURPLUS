...
Mobile.setText(findTestObject('MOBILE OBJECT/Register/txt_add_name'), GlobalVariable.name, 10)

Mobile.setText(findTestObject('MOBILE OBJECT/Register/txt_add_email'), GlobalVariable.email, 10)

Mobile.setEncryptedText(findTestObject('MOBILE OBJECT/Register/txt_add_password'), '7ZTatM+q3vAyZQd2ps7zRg==', 10)

Mobile.setEncryptedText(findTestObject('MOBILE OBJECT/Register/txt_add_confirmPassword'), '7ZTatM+q3vAyZQd2ps7zRg==', 10)
